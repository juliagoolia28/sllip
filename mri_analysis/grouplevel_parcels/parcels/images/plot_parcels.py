...
PROJECT_DIR = '/Volumes/data/users/julie/make_parcels-julie/'
...
IMG_NAME = 'ssl_rd_2.326_parcels.pdf'
# Full path to parcel volume with filename
PARCEL_VOL = PARCEL_DIR + 'ssl_rd_str_probability_map_thresh2subjs_smoothed_parcels_sig.nii.gz'
